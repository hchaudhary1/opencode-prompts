...
1. **Read any directly mentioned files first:**
   ...
   - **CRITICAL**: Read these files yourself in the main context before spawning any subagents
...
4. **Wait for all subagents to complete and synthesize findings:**
   ...
   - Compile all subagent results (both codebase and thoughts findings)
...
- **File reading**: Always read mentioned files FULLY (no limit/offset) before spawning subagents
- **Critical ordering**: Follow the numbered steps exactly
  - ALWAYS read mentioned files first before spawning subagents (step 1)
